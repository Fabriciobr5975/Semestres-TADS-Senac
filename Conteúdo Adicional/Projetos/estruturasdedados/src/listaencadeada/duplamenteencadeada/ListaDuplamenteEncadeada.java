...
/**
 * Classe para a manipulação dos objetos da lista duplamente encadeada
 *
...
public class ListaDuplamenteEncadeada<T> {
    ...
    /**
     * Método para pegar o tamanho da lista duplamente encadeada
     *
    ...
    /**
     * Método para adicionar novos elementos na lista encadeada. Caso a lista
     * estiver vazia, será adicionado o primeiro elemento sem referências para
     * próximo e anterior. Caso a lista não esteja vazia, o elemento é
     * adicionado com as referências de próximo e anterior
     *
     ...
     * depois o inicio recebe este novo elemento e o elemento que estava no
     * inicio recebe este novo elemento como anterior. Caso a lista esteja vazia
     * será adicionando o elemento sem referências de próximo e anterior
     *
     * @param elemento Recebe um elemento do tipo genérico que será colocado na
     * lista
     */
    public void adicionarNoInicio(T elemento) {
        if (this.estaVazia()) {
            ...
            this.inicio = celula;
            No<T> proxinoNo = this.inicio.getProximo();
            proxinoNo.setAnterior(this.inicio);
        }
        this.tamanho++;
    }

    /**
     * Método para adicionar novos elementos na lista duplamente encadeada, em
     * uma posição específica que seja válida
     *
     * @param elemento Recebe um elemento do tipo genérico que será colocado na
     * lista
     ...
     * valida, ou seja ela seja menor que zero ou se ela for maior que o tamanho
     * da lista
     */
    public void adicionar(T elemento, int posicao) throws IndexOutOfBoundsException {
        ...
        if (posicao == 0) {
            ...
            No<T> noAnterior = this.getElementoPosicao(posicao).getAnterior();
            No<T> proximoNo = noAnterior.getProximo();
            No<T> novoNo = new No<T>(noAnterior, elemento, proximoNo);
     ...
     * dentro deste No
     *
     * @param posicao Recebe a posição do elemento que se deseja buscar
     *
    ...
    public T buscar(int posicao) throws RuntimeException {
        ...
        return getElementoPosicao(posicao).getElemento();
    }
     ...
     * @throws RuntimeException Caso a lista esteja vazia
     */
    public T removerDoInicio() throws RuntimeException {
        if (estaVazia()) {
            throw new RuntimeException("A lista está vazia");
        }
    ...
    public T removerDoFim() throws RuntimeException {
        ...
        T elementoRemovido = this.fim.getElemento();
    ...
    public T remover(T elemento) throws RuntimeException {
        ...
        return this.remover(this.buscarPosicaoElemento(elemento));
    }

    /**
     * Método para imprimir algumas informações sobre um elemento em específico,
     * como seu antecessor, sua posição na lista e o seu sucessor. Caso ele não
     * tenha um antecessor ou um sucessor uma outra mensagem é retornada
     *
    ...
    public String imprimirInformacoesElemento(int posicao) throws RuntimeException, IndexOutOfBoundsException {
        ...
        if (posicao == 0) {
            ...
            builder.append("Não tem Antecessor, pois é o primeiro da lista").append("\n");
            builder.append("Seu Sucessor: ").append(elementoAtual.getProximo().getElemento());

        } else if (posicao == (this.tamanho - 1)) {
            builder.append("O elemento: ").append(elementoAtual.getElemento());
            builder.append(" está na posição: ").append(posicao).append("\n");
            builder.append("Seu Antecessor: ").append(elementoAtual.getAnterior().getElemento()).append("\n");
     ...
     * todos os elemento e os proximos(ponteiro que aponta para o próximo) e os
     * anteriores(ponteiro que aponta para o anterior) como null, no fim o
     ...
     * elemento antecessor
     *
     * @param posicao Recebe a posição do elemento se deseja buscar o elemento
     * anterior
     *
     * @return Retorna o elemento anterior do elemento que o usuário passou,
     * retorna null caso o elemento anterior seja null, ou seja, se não tiver o
     * antecessor
     *
     * @throws RuntimeException Caso a lista esteja vazia
     * @throws IndexOutOfBoundsException Caso a posição que foi passada não seja
     ...
     * o tamanho da lista
     */
    public T getElementoAnterior(int posicao) throws RuntimeException, IndexOutOfBoundsException {
        if (estaVazia()) {
            throw new RuntimeException("A lista está vazia");
        }
        ...
        No<T> noAnterior = this.getElementoPosicao(posicao).getAnterior();
        return (noAnterior != null ? noAnterior.getElemento() : null);
    }
     ...
     * @throws RuntimeException Caso a lista esteja vazia
     */
    public T getElementoAnterior(T elemento) throws RuntimeException {
        if (estaVazia()) {
            throw new RuntimeException("A lista está vazia");
        }
        ...
        return this.getElementoAnterior(posicao);
    }
    ...
    /**
     * Método que verifica se um elemento tem antecessor. Se o elemento não
     * tenha um antecessor o método retorna null, caso o elemento tenha um
     * antecessor ele retorna este elemento.
     *
     * @param posicao Recebe a posição do elemento se deseja buscar o elemento
     * anterior
     *
     ...
     * o tamanho da lista
     */
    public boolean elementoTemAntecessor(int posicao) throws RuntimeException, IndexOutOfBoundsException {
        if (estaVazia()) {
            throw new RuntimeException("A lista está vazia");
        }
        ...
        return (this.getElementoPosicao(posicao).getAnterior() != null);
    }

    /**
     * Método que verifica se um elemento tem antecessor. Se o elemento não
     * tenha um antecessor o método retorna null, caso o elemento tenha
     * antecessor ele retorna este elemento.
     *
     * @param elemento Recebe um elemento genérico para realizar a verificação
     * do elemento antecessor
     *
     * @return Retorna true caso o elemento tenha sucessor, caso contrário
     * retorna false
     *
     ...
     */
    public boolean elementoTemAntecessor(T elemento) throws IllegalArgumentException {
        int posicao = this.buscarPosicaoElemento(elemento);
        ...
        return this.elementoTemAntecessor(posicao);
    }
    ...
    /**
     * Método para imprimir os objetos da <code>ListaDuplamenteEncadeada</code>
     *
     * @return Retorna o Objetos de <code>ListaDuplamenteEncadeada</code>
     * formatados, para a impressão, seja no console, ou em telas, como
     * JOptionPane, JFrame entre outros
     */
    @Override
